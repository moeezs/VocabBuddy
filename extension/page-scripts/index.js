...
(() => {
    ...
    function o(e) {
      ...
      t.setAttribute("href", a),
        t.setAttribute("download", "vocabForagerData.json"),
        t.click(),
        t.remove();
    }
